    ...
    var Server = function (db, name) {
        ...
        this.add = function (table) {
            ...
            for (var i = 0; i < arguments[1].length; i++) {
                records[i] = arguments[1][i];
            }
            if (arguments[1].length == 0 || !arguments[1].length) {
                records[0] = arguments[1];
            }
            ...
            transaction.onerror = function (e) {
                ...
                console.log(" Error occured in transaction");
            };
        ...
        this.removeMultipleKey = function (table, keys) {
            var that = this;
            if (closed) {
                throw 'Database has been closed';
            }
            ...
            transaction.oncomplete = function () {
                deferred.resolve(keys, that);
            };
            transaction.onerror = function (e) {
                deferred.reject(keys, e);
            };
            transaction.onabort = function (e) {
                deferred.reject(keys, e);
            };
