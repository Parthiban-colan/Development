...
(function (e) {
    ...
    var A = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        if (k)
            for (var p in b.opt)
                "undefined" != typeof k[p] && (b.opt[p] = k[p]);
        ...
        this.css = function (d, c) {
            for (var g in c)
                b.saved.css.push([d, g, d.css(g)]), d.css(g,
                        c[g])
        };
        ...
        this.init = function () {
            ...
            if (!b.ispage || !f.cantouch && !f.isieold && !f.isie9mobile) {
                ...
                var l, k, x = ["left", "right"],
                        q;
                for (q in x)
                    k = x[q], (l = b.opt.railpadding[k]) ? g.css("padding-" + k, l + "px") : b.opt.railpadding[k] =
                            0;
                g.append(c);
                ...
                if (f.isie9mobile)
                    ...
                    if (f.cantouch || b.istouchcapable || b.opt.touchbehavior || f.hasmstouch) {
                            ...
                            if (!b.locked) {
                                ...
                                if (!f.cantouch && !this.istouchcapable && !f.hasmstouch) {
                                    if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName))
                                        return !b.ispage && f.hasmousecapture && c.setCapture(), b.opt.touchbehavior ? (c.onclick && !c._onclick && (c._onclick = c.onclick, c.onclick = function (d) {
                                            if (b.hasmoving)
                                                return !1;
                        ...
                        b.ontouchend =
                                function (d) {
                                    if (d.pointerType && 2 != d.pointerType)
                                        return !1;
                                    if (b.rail.drag && 2 == b.rail.drag.pt && (b.scrollmom.doMomentum(), b.rail.drag = !1, b.hasmoving && (b.lastmouseup = !0, b.hideCursor(), f.hasmousecapture && document.releaseCapture(), !f.cantouch)))
                                        return b.cancelEvent(d)
                                };
                        ...
                        b.ontouchmove = function (d, c) {
                            ...
                            if (b.rail.drag && 2 == b.rail.drag.pt) {
                                ...
                                g = !1;
                                if (b.rail.drag.dl)
                                    g = !0, "v" == b.rail.drag.dl ? m = b.rail.drag.sl : "h" == b.rail.drag.dl && (r = b.rail.drag.st);
                                else {
                                    var n = Math.abs(n),
                                            k = Math.abs(k),
                    ...
                    b.railh && (b.bind(b.cursorh, "mousedown", function (d) {
                        ...
                        if (!(b.rail.drag && 2 == b.rail.drag.pt))
                            return b.rail.drag = !1, b.hasmoving = !1, b.hideCursor(), f.hasmousecapture && document.releaseCapture(),
                                    b.cancelEvent(d)
                    }));
        ...
        this.showRailHr = function () {
            ...
            if (0 != b.page.maxw && (b.ispage || "none" != b.win.css("display")))
                b.railh.visibility = !0, b.railh.css("display",
                        "block");
            return b
        };
        ...
        b.opt.smoothscroll ? b.ishwscroll && f.hastransition && b.opt.usetransition ? (this.prepareTransition = function (c, e) {
            ...
            if (!b.bouncescroll || !b.railh.visibility)
                0 > b.newscrollx ? b.newscrollx = 0 : b.newscrollx > b.page.maxw &&
